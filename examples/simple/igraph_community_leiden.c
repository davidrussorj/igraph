...
int main(void) {
    ...
    igraph_community_leiden(&graph, NULL, NULL, 0.05, 0.01, 0, 1, 0, 1, &membership, &nb_clusters, &quality);
    ...
    igraph_community_leiden(&graph, NULL, NULL, 0.05, 0.01, 1, 10, 0, 1, &membership, &nb_clusters, &quality);
    ...
    igraph_community_leiden(&graph, NULL, &weights, 1.0 / (2 * igraph_ecount(&graph)), 0.01, 0, -1, 0, 1, &membership, &nb_clusters, &quality);
