...
void run_leiden_CPM(const igraph_t *graph, const igraph_vector_t *edge_weights, const igraph_real_t resolution_parameter) {
    ...
    igraph_community_leiden(graph, edge_weights, NULL, resolution_parameter, 0.01, 0, 1, false, &membership, &nb_clusters, &quality);
...
void run_leiden_modularity(igraph_t *graph, igraph_vector_t *edge_weights) {
    ...
    igraph_community_leiden(graph, edge_weights, &strength, 1.0 / (2 * m), 0.01, 0, 1, false, &membership, &nb_clusters, &quality);
